...
This project provides a solution for hosting calendar `.ics` files that allow users to subscribe to NBA, Football, Basketball and Esport game schedules directly in their personal calendars.
